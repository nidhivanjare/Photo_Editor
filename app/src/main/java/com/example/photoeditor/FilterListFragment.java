...
public class FilterListFragment extends BottomSheetDialogFragment implements FiltersListFragmentListner {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView)itemView.findViewById(R.id.recyer_view);
    ...
    public void displayThumbnail(final Bitmap bitmap) {
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                Bitmap thumbImg;
                if(bitmap == null){
                    thumbImg = BitmapUtils.getBitmapFromAssets(getActivity(),homepage.pictureName,100,100);
                }
                else
